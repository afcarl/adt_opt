#ifndef ADT_DYNAMICS_CONSTRAINT_H
#define ADT_DYNAMICS_CONSTRAINT_H
...
class Dynamics_Constraint: public Constraint_Function{
public:
	Dynamics_Constraint();
	Dynamics_Constraint(Contact_List* contact_list_in);	
	~Dynamics_Constraint();
