#ifndef ADT_COM_2D_KINEMATIC_CONSTRAINT_H
#define ADT_COM_2D_KINEMATIC_CONSTRAINT_H
...
class CoM_2D_Kinematic_Constraint: public Constraint_Function{
public:
	CoM_2D_Kinematic_Constraint(int knotpoint_in, int dim_in, double l_bound_in, double u_bound_in);	
	~CoM_2D_Kinematic_Constraint();
