...
void Jump_Opt_Variable_Limits::set_limits(){
	...
	l_delta_limits[SJActuatorID::act_bodyPitch] = -0.025; // delta_1 act spring lower limit (m)
	l_delta_limits[SJActuatorID::act_kneePitch] = -0.025;	// delta_2 act spring lower limit (m)
	l_delta_limits[SJActuatorID::act_anklePitch] = -0.025;	// delta_3 act spring lower limit (m)

	u_delta_limits[SJActuatorID::act_bodyPitch] = 0.025; // delta_1 act upper limit (m)
	u_delta_limits[SJActuatorID::act_kneePitch] = 0.025;	// delta_2 act upper limit (m)
	u_delta_limits[SJActuatorID::act_anklePitch] = 0.025;	// delta_3 act upper limit (m)
