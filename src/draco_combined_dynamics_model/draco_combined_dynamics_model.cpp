...
Draco_Combined_Dynamics_Model::Draco_Combined_Dynamics_Model(){
	...
	q_virt.resize(NUM_QDOT); q_virt.setZero();
	qdot_virt.resize(NUM_QDOT); qdot_virt.setZero();	
...
void Draco_Combined_Dynamics_Model::convert_x_xdot_to_q_qdot(const sejong::Vector &x_state, const sejong::Vector &xdot_state){
...
/*	actuator_model->getFull_joint_pos_q(z_state, q_act);
	actuator_model->getFull_joint_vel_qdot(zdot_state, qdot_act);	*/
}
